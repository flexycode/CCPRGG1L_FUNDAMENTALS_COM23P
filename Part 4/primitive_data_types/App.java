public class App {
    public static void main(String[] args) throws Exception {
        ...
        boolean iLoveJavaScript = true;
        boolean iLoveYouThreeTimesAday = false;

        System.out.println(iLoveJavaScript); // Outputs true
        System.out.println(iLoveYouThreeTimesAday); // Outputs false
    }
}